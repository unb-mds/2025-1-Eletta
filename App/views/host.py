...
def pagina_de_criacao_de_pauta(page: ft.Page, controlador = 'Controlador') -> ft.View:
            ...
            content=ft.Column( # Coluna com os conteudos da pagina
                controls=[
                    ft.Dropdown( # Seleção do tempo
                        ...
                        hint_text="00:30",
                        options=[
                            ft.dropdown.Option(key ="00:30", content=ft.Text(value ="00:30", color="#4b7d78" )), # Opções
                            ft.dropdown.Option(key ="00:45", content=ft.Text(value ="00:45", color="#4b7d78" )),
                            ft.dropdown.Option(key ="01:00", content=ft.Text(value ="01:00", color="#4b7d78" )),
                        ],
                        color = "#4b7d78",
                        border_color="#4b7d78",
    ...
    return ft.View('/criacao_de_pauta', controls=conteudo_da_pagina, vertical_alignment = ft.MainAxisAlignment.CENTER, horizontal_alignment = ft.CrossAxisAlignment.CENTER, bgcolor=ft.colors.WHITE, padding= 0)
