...
def pagina_de_votacao(page: ft.Page, controlador: 'Controlador') -> ft.View:
    ...
    return ft.View('/votacao', controls=conteudo_da_pagina, vertical_alignment=ft.MainAxisAlignment.CENTER, horizontal_alignment=ft.CrossAxisAlignment.CENTER, bgcolor=ft.colors.WHITE)
...
def pagina_de_confirmacao(page: ft.Page, controlador: 'Controlador', voto_selecionado: str) -> ft.View:
    ...
    return ft.View("/confirmacao", controls=conteudo, vertical_alignment=ft.MainAxisAlignment.CENTER, horizontal_alignment=ft.CrossAxisAlignment.CENTER, bgcolor=ft.colors.WHITE)
